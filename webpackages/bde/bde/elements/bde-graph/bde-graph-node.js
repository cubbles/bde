  ...
  TheGraph.Node = React.createFactory( React.createClass({
    ...
    onTrackEnd: function (event) {
      ...
      if (this.props.export) {
        ...
        this.props.graph.endTransaction('movenode',{nodeID:this.props.nodeID,x:this.props.node.metadata.x,y:this.props.node.metadata.y});
      }
    },
    ...
    render: function() {
      ...
      // (ene) style-scope & bde-graph set hard for fixing highlighting issue
      var nodeOptions = {
        className: "node drag"+
